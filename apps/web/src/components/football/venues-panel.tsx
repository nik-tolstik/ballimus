...
export function VenuesPanel({ venues, onCreate, onUpdate, onArchive, onRestore, saving }: VenuesPanelProps) {
  ...
  return <section className="flex flex-col gap-5">
    <div className="flex items-end justify-between gap-4"><h1 className="text-2xl font-semibold tracking-tight">Места</h1><Button className="h-10 px-3" onClick={openCreate}><Plus data-icon="inline-start" />Добавить</Button></div>
