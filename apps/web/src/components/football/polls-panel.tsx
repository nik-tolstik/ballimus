...
import { Archive, BarChart3, Bell, Check, ListChecks, LoaderCircle, Minus, Plus, RotateCcw, Send, TriangleAlert, UserRoundCheck, UsersRound, type LucideIcon } from 'lucide-react'
...
function PollDetails({ poll, saving, onRepublish, onArchive }: { readonly poll: PollResponseDto; readonly saving: boolean; readonly onRepublish: () => void; readonly onArchive: () => void }) {
...
export function PollsPanel({ polls, saving, onCreate, onRepublish, onArchive }: { readonly polls: readonly PollResponseDto[]; readonly saving: boolean; readonly onCreate: (values: PollEditorValues) => void; readonly onRepublish: (pollId: string) => Promise<boolean>; readonly onArchive: (pollId: string) => Promise<boolean> }) {
