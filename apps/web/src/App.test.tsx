...
describe('information-card Mini App', () => {
  ...
  it('normalizes a card without roster, players, or vote fields', () => {
    const match = normalizeMatch({
      ...
      fieldPriceRubles: 25, version: 1, creatorTelegramUserId: '11', archivedAt: null, deletionRequestedAt: null, createdAt: '2026-08-01T10:00:00.000Z', updatedAt: '2026-08-01T10:00:00.000Z',
