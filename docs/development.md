...
6. Create a native poll with one option notification enabled. Verify the poll appears in Chat, the default threshold is 10, and reaching it produces one notification only.
