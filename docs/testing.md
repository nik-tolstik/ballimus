...
4. Create a non-anonymous native poll with an option notification enabled. Verify publication, live counts, threshold crossings, delayed shortage behavior, manual republishing after a failed publication, notification editing, and archival.
